...
const IrBookingListing = class {
  ...
  renderItemRange() {
    ...
    booking_listing_service.booking_listing.userSelection = Object.assign(Object.assign({}, booking_listing_service.booking_listing.userSelection), { start_row: startItem - 1, end_row: endItem });
    return `${locales_store.locales.entries.Lcz_View} ${startItem} - ${endItem} ${locales_store.locales.entries.Lcz_Of} ${totalCount}`;
  }
  async updateData() {
    const { total_count } = booking_listing_service.booking_listing.userSelection;
    let endItem = this.currentPage * this.itemsPerPage;
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("ir-interceptor", null), index.h("ir-toast", null), index.h("div", { class: "p-2 main-container" }, index.h("ir-listing-header", { propertyId: this.propertyid, language: this.language, baseurl: this.baseurl }), index.h("section", null, index.h("div", { class: "card p-1 flex-fill m-0 mt-2" }, index.h("table", { class: "table table-striped table-bordered no-footer dataTable" }, index.h("thead", null, index.h("tr", null, index.h("th", { scope: "col", class: "text-left" }, (_a = locales_store.locales.entries) === null || _a === void 0 ? void 0 :
      _a.Lcz_Booking, "#"), index.h("th", { scope: "col" }, (_b = locales_store.locales.entries) === null || _b === void 0 ? void 0 : _b.Lcz_BookedOn), index.h("th", { scope: "col" }, (_c = locales_store.locales.entries) === null || _c === void 0 ? void 0 : _c.Lcz_GuestSource), index.h("th", { scope: "col" }, index.h("p", { class: 'm-0' }, (_d = locales_store.locales.entries) === null || _d === void 0 ? void 0 : _d.Lcz_Price), index.h("p", { class: 'm-0 btn due-btn' }, (_e = locales_store.locales.entries) === null || _e === void 0 ? void 0 : _e.Lcz_Balance)), index.h("th", { scope: "col", class: "text-left" }, (_f = locales_store.locales.entries) === null || _f === void 0 ? void 0 : _f.Lcz_Services), index.h("th", { scope: "col", class: "in-out" }, (_g = locales_store.locales.entries) === null || _g === void 0 ? void 0 : _g.Lcz_InOut), index.h("th", { scope: "col" }, (_h = locales_store.locales.entries) === null || _h === void 0 ? void 0 : _h.Lcz_Status), index.h("th", { scope: "col" }, index.h("p", { class: "sr-only" }, "actions")))), index.h("tbody", { class: "" }, (_j = booking_listing_service.booking_listing.bookings) === null || _j === void 0 ? void 0 : _j.map(booking => {
      var _a;
      let confirmationBG = '';
