...
const unassigned_dates_store = require('./unassigned_dates.store-fbcf575e.js');
const utils = require('./utils-34918619.js');
const toBeAssigned_service = require('./toBeAssigned.service-94a00a5e.js');
...
const IglCalBody = class {
  ...
  addNewEvent(roomCategory) {
    ...
    this.newEvent = {
      ...
      RATE_PLAN: '',
      ARRIVAL_TIME: '',
      TITLE: utils.locales.entries.Lcz_NewBookingFor,
    ...
    this.newEvent.BLOCK_DATES_TITLE = utils.locales.entries.Lcz_BlockDatesFor + popupTitle;
...
const IglCalHeader = class {
  ...
  getNewBookingModel() {
    ...
    return {
      ...
      TITLE: utils.locales.entries.Lcz_NewBooking,
...
const IglLegends = class {
  ...
  render() {
    return (index.h(index.Host, { class: "legendContainer pr-1 text-left" }, index.h("div", { class: 'w-full' }, index.h("div", { class: 'w-full' }, index.h("div", { class: "stickyHeader pt-1 " }, index.h("p", { class: "legendHeader" }, utils.locales.entries.Lcz_Legend), index.h("div", { class: "legendCloseBtn", onClick: () => this.handleOptionEvent('closeSideMenu') }, index.h("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { fill: "#6b6f82", d: "M41.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L109.3 256 246.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-160 160zm352-160l-160 160c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L301.3 256 438.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0z" }))), index.h("hr", null)), index.h("div", { class: "mt-2 pl-1" }, this.legendData.map(legendInfo => (index.h("div", { class: "legendRow " }, index.h("div", { class: `legend_${legendInfo.design} mr-1`, style: { backgroundColor: legendInfo.color } }), index.h("span", { class: "font-small-3" }, legendInfo.name))))), index.h("hr", null), index.h("div", { class: "mt-2" }, index.h("div", { class: "legendCalendar" }, index.h("div", { class: "legendRow align-items-center" }, index.h("div", { class: "legendCal br-t br-s br-bt" }, index.h("strong", null, "MAR 2022")), index.h("div", { class: "highphenLegend" }, utils.locales.entries.Lcz_MonthAndYear)), index.h("div", { class: "legendRow" }, index.h("div", { class: "legendCal headerCell align-items-center br-s" }, index.h("span", { class: "badge badge-info  badge-pill" }, "3")), index.h("div", { class: "highphenLegend" }, index.h("div", null, utils.locales.entries.Lcz_UnassignedUnits))), index.h("div", { class: "legendRow" }, index.h("div", { class: "legendCal dayTitle br-s" }, "Fri 18"), index.h("div", { class: "highphenLegend" }, utils.locales.entries.Lcz_Date)), index.h("div", { class: "legendRow" }, index.h("div", { class: "legendCal br-s br-bt dayCapacityPercent" }, "15%"), index.h("div", { class: "highphenLegend" }, utils.locales.entries.Lcz_Occupancy)), index.h("div", { class: "legendRow" }, index.h("div", { class: "legendCal br-s br-bt  font-weight-bold total-availability" }, "20"), index.h("div", { class: "highphenLegend" }, utils.locales.entries.Lcz_TotalAvailability))))))));
  }
};
...
const IglToBeAssigned = class {
  ...
  componentWillLoad() {
    this.reArrangeData();
    this.loadingMessage = utils.locales.entries.Lcz_FetchingUnAssignedUnits;
  }
  ...
  render() {
    var _a;
    return (index.h(index.Host, { class: "tobeAssignedContainer pr-1 text-left" }, index.h("div", null, index.h("div", null, index.h("div", { class: "stickyHeader pt-1" }, index.h("p", { class: "tobeAssignedHeader " }, utils.locales.entries.Lcz_Assignments), index.h("ir-icon", { class: "closeBtn pt-2", onIconClickHandler: () => this.handleOptionEvent('closeSideMenu') }, index.h("svg", { slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { fill: "#6b6f82", d: "M41.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L109.3 256 246.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-160 160zm352-160l-160 160c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L301.3 256 438.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0z" }))), index.h("hr", null), Object.keys(this.data).length === 0 ? (index.h("p", null, utils.locales.entries.Lcz_AllBookingsAreAssigned)) : this.isLoading ? (index.h("p", null, this.loadingMessage)) : (index.h(index.Fragment, null, this.orderedDatesList.length ? (index.h("div", { class: `custom-dropdown border border-light rounded text-center ` + (this.showDatesList ? 'show' : ''), id: "dropdownMenuButton", "data-toggle": "dropdown", "aria-haspopup": "true", "aria-expanded": "false" }, index.h("div", { class: 'dropdown-toggle' }, index.h("span", { class: "font-weight-bold" }, this.data[this.selectedDate].dateStr), index.h("svg", { class: 'caret-icon', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 448 512", height: 14, width: 14 }, index.h("path", { fill: "#6b6f82", d: "M201.4 342.6c12.5 12.5 32.8 12.5 45.3 0l160-160c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L224 274.7 86.6 137.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l160 160z" }))), index.h("div", { class: "dropdown-menu dropdown-menu-right full-width", "aria-labelledby": "dropdownMenuButton" }, (_a = this.orderedDatesList) === null || _a === void 0 ? void 0 : _a.map(ordDate => (index.h("div", { class: "dropdown-item pointer", onClick: () => this.showForDate(ordDate) }, this.data[ordDate].dateStr)))))) : (utils.locales.entries.Lcz_AllBookingsAreAssigned)))), !this.isLoading && (index.h("div", { class: "scrollabledArea" }, this.orderedDatesList.length ? (Object.keys(this.data[this.selectedDate].categories).length ? (this.getCategoryView()) : (index.h("div", { class: "mt-1" }, utils.locales.entries.Lcz_AllAssignForThisDay))) : null))))));
  }
  static get watchers() { return {
...
const IrBookingDetails = class {
  ...
  async initializeApp() {
    try {
      ...
      if (!utils.locales.entries) {
        utils.locales.entries = languageTexts.entries;
        utils.locales.direction = languageTexts.direction;
      }
    ...
    switch (target.id) {
      ...
      case 'room-add':
        this.bookingItem = {
          ...
          TITLE: `${utils.locales.entries.Lcz_AddingUnitToBooking}# ${this.bookingData.booking_nbr}`,
          defaultDateRange: {
    ...
    if (this.tempStatus !== 'Select' && this.tempStatus !== null) {
      try {
        ...
        this.toast.emit({
          type: 'success',
          description: '',
          title: utils.locales.entries.Lcz_StatusUpdatedSuccessfully,
          position: 'top-right',
        });
      }
      catch (error) {
      ...
      this.toast.emit({
        type: 'error',
        description: '',
        title: utils.locales.entries.Lcz_SelectStatus,
        position: 'top-right',
      });
    }
  }
  ...
  render() {
    ...
    return [
      ...
      })), calendarData.calendar_data.pickup_service.is_enabled && this.bookingData.is_direct && (index.h("div", { class: "mb-1" }, index.h("div", { class: 'd-flex w-100 mb-1 align-items-center justify-content-between' }, index.h("p", { class: 'font-size-large p-0 m-0 ' }, utils.locales.entries.Lcz_Pickup), index.h("ir-icon", { class: "pointer ", id: "pickup" }, index.h("svg", { slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "20", width: "20", viewBox: "0 0 512 512" }, index.h("path", { fill: "#6b6f82", d: "M471.6 21.7c-21.9-21.9-57.3-21.9-79.2 0L362.3 51.7l97.9 97.9 30.1-30.1c21.9-21.9 21.9-57.3 0-79.2L471.6 21.7zm-299.2 220c-6.1 6.1-10.8 13.6-13.5 21.9l-29.6 88.8c-2.9 8.6-.6 18.1 5.8 24.6s15.9 8.7 24.6 5.8l88.8-29.6c8.2-2.7 15.7-7.4 21.9-13.5L437.7 172.3 339.7 74.3 172.4 241.7zM96 64C43 64 0 107 0 160V416c0 53 43 96 96 96H352c53 0 96-43 96-96V320c0-17.7-14.3-32-32-32s-32 14.3-32 32v96c0 17.7-14.3 32-32 32H96c-17.7 0-32-14.3-32-32V160c0-17.7 14.3-32 32-32h96c17.7 0 32-14.3 32-32s-14.3-32-32-32H96z" })))), this.bookingData.pickup_info && (index.h("div", { class: 'card' }, index.h("div", { class: 'p-1' }, index.h("div", { class: 'd-flex align-items-center py-0 my-0 pickup-margin' }, index.h("p", { class: 'font-weight-bold mr-1 py-0 my-0' }, utils.locales.entries.Lcz_Date, ": ", index.h("span", { class: 'font-weight-normal' }, moment.hooks(this.bookingData.pickup_info.date, 'YYYY-MM-DD').format('ddd, DD MM YYYY'))), index.h("p", { class: 'font-weight-bold flex-fill py-0 my-0' }, utils.locales.entries.Lcz_Time, ":", index.h("span", { class: 'font-weight-normal' }, " ", `${this.bookingData.pickup_info.hour}:${this.bookingData.pickup_info.minute}`)), index.h("p", { class: 'font-weight-bold py-0 my-0' }, utils.locales.entries.Lcz_DueUponBooking, ":", ' ', index.h("span", { class: 'font-weight-normal' }, this.bookingData.pickup_info.currency.symbol, this.bookingData.pickup_info.total))), index.h("p", { class: 'font-weight-bold py-0 my-0' }, utils.locales.entries.Lcz_FlightDetails, ":", index.h("span", { class: 'font-weight-normal' }, " ", `${this.bookingData.pickup_info.details}`)), index.h("p", { class: 'py-0 my-0 pickup-margin' }, `${this.bookingData.pickup_info.selected_option.vehicle.description}`), index.h("p", { class: 'font-weight-bold py-0 my-0 pickup-margin' }, utils.locales.entries.Lcz_NbrOfVehicles, ":", index.h("span", { class: 'font-weight-normal' }, " ", `${this.bookingData.pickup_info.nbr_of_units}`)), index.h("p", { class: 'small py-0 my-0 pickup-margin' }, calendarData.calendar_data.pickup_service.pickup_instruction.description, calendarData.calendar_data.pickup_service.pickup_cancelation_prepayment.description))))))), index.h("div", { class: "col-12 p-0 m-0 pl-lg-1 col-lg-6" }, index.h("ir-payment-details", { defaultTexts: this.defaultTexts, bookingDetails: this.bookingData })))),
...
const IrRoomNights = class {
  ...
  render() {
    var _a, _b, _c;
    if (!this.bookingEvent) {
      return index.h("p", null, utils.locales.entries.Lcz_Loading);
    }
    return (index.h(index.Host, null, index.h("div", { class: "card position-sticky mb-0 shadow-none p-0 " }, index.h("div", { class: "d-flex mt-2 align-items-center justify-content-between " }, index.h("h3", { class: "card-title text-left pb-1 font-medium-2 px-2" }, utils.locales.entries.Lcz_AddingRoomNightsTo, " ", (_b = (_a = this.selectedRoom) === null || _a === void 0 ? void 0 : _a.roomtype) === null || _b === void 0 ? void 0 :
      _b.name, " ", ((_c = this.selectedRoom) === null || _c === void 0 ? void 0 : _c.unit).name), index.h("button", { type: "button", class: "close close-icon", onClick: () => this.closeRoomNightsDialog.emit({ type: 'cancel', pool: this.pool }) }, index.h("ir-icon", { icon: "ft-x", class: 'm-0' })))), index.h("section", { class: 'text-left px-2' }, index.h("p", { class: 'font-medium-1' }, `${utils.locales.entries.Lcz_Booking}#`, " ", this.bookingNumber), index.h("p", { class: 'font-weight-bold font-medium-1' }, `${utils.formatDate(this.fromDate, 'YYYY-MM-DD')} - ${utils.formatDate(this.toDate, 'YYYY-MM-DD')}`), this.initialLoading ? (index.h("p", { class: 'mt-2 text-secondary' }, utils.locales.entries['Lcz_CheckingRoomAvailability '])) : (index.h(index.Fragment, null, index.h("p", { class: 'font-medium-1 mb-0' }, `${this.selectedRoom.rateplan.name}`, " ", this.selectedRoom.rateplan.is_non_refundable && index.h("span", { class: 'irfontgreen' }, utils.locales.entries.Lcz_NonRefundable)), (this.inventory === 0 || this.inventory === null) && index.h("p", { class: "font-medium-1 text danger" }, utils.locales.entries.Lcz_NoAvailabilityForAdditionalNights), this.selectedRoom.rateplan.custom_text && index.h("p", { class: 'text-secondary mt-0' }, this.selectedRoom.rateplan.custom_text), this.renderDates()))), index.h("section", { class: 'd-flex align-items-center mt-2 px-2' }, index.h("button", { disabled: this.isLoading, type: "button", class: 'btn btn-secondary full-width', onClick: () => this.closeRoomNightsDialog.emit({ type: 'cancel', pool: this.pool }) }, utils.locales === null || utils.locales === void 0 ? void 0 : utils.locales.entries.Lcz_Cancel), this.inventory > 0 && this.inventory !== null && (index.h("button", { disabled: this.isButtonDisabled(), type: "button", class: 'btn btn-primary ml-2 full-width', onClick: this.handleRoomConfirmation.bind(this) }, this.isLoading && index.h("i", { class: "la la-circle-o-notch spinner mx-1" }), utils.locales === null || utils.locales === void 0 ? void 0 :
      utils.locales.entries.Lcz_Confirm)))));
  }
};
...
//# sourceMappingURL=igl-cal-body_9.cjs.entry.js.map