...
const IrChannelMapping = class {
  ...
  render() {
    return (index.h(index.Host, null, index.h("ul", { class: "m-0 p-0" }, calendarData.calendar_data.channels[0].property.room_types.map(property => (index.h("li", { class: "map-row", key: property.id }, index.h("span", null, property.name), index.h("svg", { xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, index.h("path", { d: "M438.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-160-160c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L338.8 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l306.7 0L233.4 393.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l160-160z" })), index.h("span", { class: "mapped-to-text" }, "not mapped")))))));
  }
};
