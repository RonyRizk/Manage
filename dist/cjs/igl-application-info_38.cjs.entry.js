...
const booking_service = require('./booking.service-5264c56c.js');
const booking = require('./booking-956095fe.js');
const events_service = require('./events.service-39c60389.js');
const booking_service$1 = require('./booking.service-5264c56c2.js');
...
const IrBookingDetails = class {
  ...
  render() {
    ...
    return [
      ...
      index.h(index.Fragment, null, index.h("ir-dialog", { ref: el => (this.dialogRef = el) }, index.h("div", { slot: "modal-body", class: "p-1" }, index.h("h3", { class: " text-left mb-1 dialog-title " }, locales_store.locales.entries.Lcz_PMS_Logs), !this.isPMSLogLoading && (index.h(index.Fragment, null, index.h("div", { class: "d-flex align-items-center" }, index.h("p", { class: "list-title" }, locales_store.locales.entries.Lcz_SentAt), ((_b = this.pms_status) === null || _b === void 0 ? void 0 : _b.sent_date) ? (index.h("p", { class: "list-item" }, (_c = this.pms_status) === null || _c === void 0 ? void 0 :
        _c.sent_date, " ", _formatTime((_d = this.pms_status) === null || _d === void 0 ? void 0 : _d.sent_hour.toString(), (_e = this.pms_status) === null || _e === void 0 ? void 0 : _e.sent_minute.toString()))) : (index.h("p", { class: `list-item ${((_f = this.pms_status) === null || _f === void 0 ? void 0 : _f.sent_date) ? 'green' : 'red'}` }, ((_g = this.pms_status) === null || _g === void 0 ? void 0 : _g.is_acknowledged) ? locales_store.locales.entries.Lcz_YES : locales_store.locales.entries.Lcz_NO))), index.h("div", { class: "d-flex align-items-center" }, index.h("h4", { class: "list-title" }, locales_store.locales.entries.Lcz_Acknowledged), index.h("p", { class: `list-item ${((_h = this.pms_status) === null || _h === void 0 ? void 0 : _h.is_acknowledged) ? 'green' : 'red'}` }, ((_j = this.pms_status) === null || _j === void 0 ? void 0 : _j.is_acknowledged) ? locales_store.locales.entries.Lcz_YES : locales_store.locales.entries.Lcz_NO))))))),
    ];
  }
