import { r as registerInstance, a as createEvent, h, e as Host, F as Fragment, i as getElement } from './index-b28ea4d3.js';
import { B as BookingService$1 } from './booking.service-a467a994.js';
import { h as hooks } from './moment-7d60e5ef.js';
import { i as isBlockUnit, b as dateDifference, k as getReleaseHoursString } from './utils-b1c9d329.js';
...
import { i as isBlockUnit$1 } from './utils-24de7915.js';
...
const IglBookingEvent = class {
    ...
    try {
      ...
      if (event.detail.moveToDay === 'revert' || event.detail.toRoomId === 'revert') {
        ...
        if (this.isTouchStart && this.moveDiffereneX <= 5 && this.moveDiffereneY <= 5 && !this.isStreatch) {
          if (isBlockUnit$1(this.bookingEvent.STATUS_CODE)) {
            this.showEventInfo(true);
          }
          else if (['IN-HOUSE', 'CONFIRMED', 'PENDING-CONFIRMATION', 'CHECKED-OUT'].includes(this.bookingEvent.STATUS)) {
            await this.fetchAndAssignBookingData();
  ...
  handleMouseMove(event) {
    if (this.isDragging) {
      ...
      if (this.resizeSide === 'move') {
        ...
        if (!this.bookingEvent.is_direct && !isBlockUnit$1(this.bookingEvent.STATUS_CODE)) {
          return;
        }
  ...
  render() {
    ...
    return (h(Host, { class: `bookingEvent ${this.isNewEvent() || this.isHighlightEventType() ? 'newEvent' : ''} ${legend.clsName} `, style: this.getPosition(), id: 'event_' + this.getBookingId() }, h("div", { class: `bookingEventBase ${!this.bookingEvent.is_direct &&
        !isBlockUnit$1(this.bookingEvent.STATUS_CODE) &&
