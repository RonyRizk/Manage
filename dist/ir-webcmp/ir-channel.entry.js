import { h, r as registerInstance, e as Host, F as Fragment, i as getElement } from './index-b28ea4d3.js';
import { R as RoomService } from './room.service-f08f07fb.js';
import { s as setChannelIdAndActiveState, u as updateChannelSettings, a as selectChannel, t as testConnection, r as resetStore, c as channels_data } from './channel.store-c2c85d22.js';
import { l as locales } from './locales.store-0a8c61f1.js';
import { a as axios } from './index-315af25e.js';
import { C as ChannelService } from './channel.service-9259bbe0.js';
...
const IrChannel = class {
  ...
  render() {
    ...
    if (this.isLoading) {
      return (h("div", { class: "h-screen d-flex flex-column align-items-center justify-content-center" }, h("ir-loading-screen", null)));
    }
