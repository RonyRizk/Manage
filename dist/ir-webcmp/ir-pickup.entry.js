...
import { c as calendar_data } from './calendar-data-cf12969c.js';
...
const IrPickup = class {
  ...
  handleLocationChange(event) {
    ...
    if (value !== '') {
      ...
      this.pickupData = Object.assign(Object.assign({}, this.pickupData), { location: value, due_upon_booking: this.updateDue({
  ...
  handleVehicleTypeChange(e) {
    ...
    this.pickupData = Object.assign(Object.assign({}, this.pickupData), { due_upon_booking: this.updateDue({
        amount: locationChoice.amount,
        code: locationChoice.pricing_model.code,
