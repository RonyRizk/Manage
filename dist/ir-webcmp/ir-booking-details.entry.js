import { r as registerInstance, a as createEvent, h, F as Fragment, g as getElement } from './index-c229806f.js';
...
const IrBookingDetails = class {
  ...
  render() {
    ...
    return [
      ...
      })), h("div", { class: "mb-1" }, h("div", { class: 'd-flex w-100  align-items-center justify-content-between' }, h("h4", null, locales.entries.Lcz_Pickup), h("ir-icon", { id: "pickup", icon: "ft-edit color-ir-dark-blue-hover h4 pointer" })))), h("div", { class: "col-12 p-0 m-0 pl-lg-1 col-lg-6" }, h("ir-payment-details", { defaultTexts: this.defaultTexts, bookingDetails: this.bookingData, item: this.bookingDetails, paymentExceptionMessage: this.paymentExceptionMessage })))),
