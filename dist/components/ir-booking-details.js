...
import { d as defineCustomElement$b } from './ir-checlbox.js';
...
function defineCustomElement$1() {
  ...
  const components = ["ir-booking-details", "ir-button", "ir-checkbox", "ir-guest-info", "ir-icon", "ir-input-text", "ir-label", "ir-modal", "ir-payment-details", "ir-room", "ir-select", "ir-sidebar"];
