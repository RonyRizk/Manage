import { r as registerInstance, c as createEvent, h, H as Host, g as getElement, F as Fragment } from './index-2fc15efd.js';
import { c as channels_data, t as testConnection, u as updateChannelSettings, a as selectChannel, b as addMapping, d as setMappedChannel } from './channel.store-bbd7ff01.js';
...
const IrChannelMapping = class {
  ...
  render() {
    var _a, _b, _c, _d, _e;
    return (h(Host, { class: "py-md-2 px-md-2" }, h("div", { class: "d-flex p-0 m-0 w-100 justify-content-end" }, h("button", { onClick: () => {
        setMappedChannel();
...
export { IrChannelGeneral as ir_channel_general, IrChannelHeader as ir_channel_header, IrChannelMapping as ir_channel_mapping, IrIcons as ir_icons };

//# sourceMappingURL=ir-channel-general_4.entry.js.map